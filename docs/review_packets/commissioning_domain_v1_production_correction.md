...
| Proposed corrected | `commissioning-domain-v1-environment-energy-corrected` | 7 | 66 | 60 | `dea1b8c7a0071462a5eb91f24d22287dc156fda9edcfa71a2abf6e570c2459c5` |
...
```powershell
python backend/scripts/commissioning_domain_corrected_artifact_store.py --check --target production --batch-key commissioning-domain-v1-environment-energy-corrected --source-commit 08e675e2039d76f16b8c9576e4b5a8254bc44d72 --manifest-sha256 dea1b8c7a0071462a5eb91f24d22287dc156fda9edcfa71a2abf6e570c2459c5 --migration-sha256 b4fffce458ebda4b09ce92cd1998468c4d18bad2450e43e9567776340337a9f7
```

Operation B — exact corrected apply:

```powershell
python backend/scripts/commissioning_domain_corrected_artifact_store.py --apply --target production --confirm-production-apply --batch-key commissioning-domain-v1-environment-energy-corrected --source-commit 08e675e2039d76f16b8c9576e4b5a8254bc44d72 --manifest-sha256 dea1b8c7a0071462a5eb91f24d22287dc156fda9edcfa71a2abf6e570c2459c5 --migration-sha256 b4fffce458ebda4b09ce92cd1998468c4d18bad2450e43e9567776340337a9f7
```
...
source commit, 74/68 or 66/60 count, semantic hash, migration/schema state,

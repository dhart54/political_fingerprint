...
class M12DEnvironmentEnergyActionMeaningAcceptanceTests(unittest.TestCase):
    @classmethod
    ...
    def test_repository_authority_and_implementation_are_exact_63(self) -> None:
        result = validate_repository()
        self.assertEqual(result["accepted_decision_count"], 63)
    ...
    def test_deterministic_regeneration(self) -> None:
        self.assertEqual(write_outputs(check=True)["accepted_decision_count"], 63)
        self.assertEqual(build_artifacts()["authority"], self.authority)

    def test_generic_schemas_accept_m11d_and_m12d(self) -> None:
    ...
    def test_not_voting_remains_nondirectional(self) -> None:
        ...
        self.assertEqual(
            records["house:119:2:136"]["accepted_exact_choice_position_effect"],

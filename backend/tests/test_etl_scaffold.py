...
def test_run_ingest_supports_house_clerk_cache_source() -> None:
    ingest_result = run_ingest(source="house_clerk_cache")
...
def test_run_ingest_supports_senate_xml_cache_source() -> None:
    ingest_result = run_ingest(source="senate_xml_cache")

...
const definitions = [
  ...
  [160, "2025-06-10", "nay", "Previous question on H. Res. 489", "procedural", "passed"],
  [161, "2025-06-10", "nay", "Adoption of H. Res. 489", "procedural", "passed"],
  [166, "2025-06-12", "yea", "HALT Fentanyl Act (S. 331)", "final_passage", "passed"],
  [267, "2025-09-16", "nay", "Previous question on H. Res. 707", "procedural", "passed"],
  [268, "2025-09-16", "nay", "Adoption of H. Res. 707", "procedural", "passed"],
  [275, "2025-09-17", "nay", "D.C. Policing Protection Act", "final_passage", "passed"],
  [290, "2025-11-18", "nay", "Previous question on H. Res. 879", "procedural", "passed"],
  [291, "2025-11-18", "nay", "Adoption of H. Res. 879", "procedural", "passed"],
  [299, "2025-11-19", "nay", "CLEAN DC Act", "final_passage", "passed"],
];

const rows = definitions.map(([roll, date, position, title, voteType, result]) => ({
  ...
  uncertainty_note: voteType === "procedural" ? "Context only." : "",
  interpretation_reason: voteType === "procedural" ? "context_only" : "policy_vote",
  classification_reason: voteType === "procedural" ? "limited_context" : "policy_vote",
  source_basis: [],
  source_url: `https://clerk.house.gov/Votes/2025${roll}`,
  vote_type: voteType,
  vote_context: { vote_type: voteType, final_result: result, member_party: "D", member_voted_with_party_majority: true },
}));

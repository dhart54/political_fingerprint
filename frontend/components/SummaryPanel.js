...
export default function SummaryPanel({
  ...
  return (
    <section className="mt-8 rounded-[2.5rem] border border-stone-300/80 bg-white/75 p-5 shadow-[0_20px_80px_rgba(72,52,24,0.12)] backdrop-blur lg:p-6">
            ...
            <div className="mt-4 space-y-3">
              {summaryPoints.length === 0 ? (
                <div className="rounded-[1.5rem] border border-white/8 bg-white/4 px-4 py-4">
                  <p className="text-base leading-8 text-stone-100">
      ...
      <article className="mt-5 rounded-[1.8rem] border border-amber-200 bg-amber-50/80 px-5 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)]">
